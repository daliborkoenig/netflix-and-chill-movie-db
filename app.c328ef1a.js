...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./images/background.jpg":[["background.565aafb9.jpg","images/background.jpg"],"images/background.jpg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
var closeScreen = document.querySelector(".closeScreen");
var closeScreen2 = document.querySelector(".closeScreen2");
var formElem = document.querySelector("form");
var userInp = document.querySelector("#searchBar");
var searchBtn = document.querySelector("#search");
var searchStr = "";
var popMov = document.querySelector("#popMov");
var popTV = document.querySelector("#popTV");
var randMov = document.querySelector("#randMov");
var randTV = document.querySelector("#randTV"); // http://www.omdbapi.com/?t=the+avengers&plot=full
...
searchBtn.addEventListener("click", function (e) {
  ...
  if (userInp.value.length == 0) {} else {
    var _searchStr = userInp.value;
    checkWords(_searchStr);
  }
...
function _searchContent() {
  _searchContent = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var res, result;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            _context2.next = 5;
            return fetch("https://api.themoviedb.org/3/search/multi?api_key=276770bbde205f73041b92d3087003ed&language=en-US&query=".concat(searchStr, "&page=1&include_adult=false"));
          ...
          case 8:
            ...
            if (result.results.length == 0) {} else {
...
popMov.addEventListener("click", function (e) {
  e.preventDefault();
  popularMovies();
});
popTV.addEventListener("click", function (e) {
  e.preventDefault();
  popularTV();
});
randMov.addEventListener("click", function (e) {
  e.preventDefault();
  randomMovie();
});
randTV.addEventListener("click", function (e) {
  e.preventDefault();
  randomTV();
}); // functions to generate content for other buttons

function randomMovie() {
  return _randomMovie.apply(this, arguments);
}

function _randomMovie() {
  _randomMovie = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var res, result;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return fetch("https://api.themoviedb.org/3/movie/popular?api_key=276770bbde205f73041b92d3087003ed&page=1");
...
function randomTV() {
  return _randomTV.apply(this, arguments);
}

function _randomTV() {
  _randomTV = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var res, result;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return fetch("https://api.themoviedb.org/3/tv/popular?api_key=276770bbde205f73041b92d3087003ed&page=1");
...
function popularMovies() {
  return _popularMovies.apply(this, arguments);
}

function _popularMovies() {
  _popularMovies = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var res, result;
...
function popularTV() {
  return _popularTV.apply(this, arguments);
} // function that fetches the genre list from api and then compares it with our item


function _popularTV() {
  _popularTV = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var res, result;
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return fetch("https://api.themoviedb.org/3/tv/popular?api_key=276770bbde205f73041b92d3087003ed&language=en-US&page=1");
...
function getGenre(_x) {
  return _getGenre.apply(this, arguments);
} // function to fetch trailer by type and id of our item


function _getGenre() {
  _getGenre = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(arr) {
    var genres, res, result;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            genres = [];
            _context7.next = 3;
            return fetch("https://api.themoviedb.org/3/genre/movie/list?api_key=276770bbde205f73041b92d3087003ed&language=en-US");
...
function getTrailer(_x2, _x3) {
  return _getTrailer.apply(this, arguments);
} // function to get cast from API using id from our item


function _getTrailer() {
  _getTrailer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(id, type) {
    var res, result, _res, _result;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 3;
            return fetch("https://api.themoviedb.org/3/movie/".concat(id, "/videos?api_key=276770bbde205f73041b92d3087003ed&language=en-US"));
          ...
          case 6:
            ...
            return _context8.abrupt("return", result.results);

          case 10:
            _context8.next = 12;
            return fetch("https://api.themoviedb.org/3/tv/".concat(id, "/videos?api_key=276770bbde205f73041b92d3087003ed&language=en-US"));
          ...
          case 15:
            ...
            return _context8.abrupt("return", _result.results);
...
function getCast(_x4, _x5) {
  return _getCast.apply(this, arguments);
} // function to animate the window opening when clicked on one of the options


function _getCast() {
  _getCast = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(id, type) {
    var result, res, _res2;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 3;
            return fetch("https://api.themoviedb.org/3/movie/".concat(id, "/credits?api_key=276770bbde205f73041b92d3087003ed&language=en-US"));
          ...
          case 9:
            _context9.next = 11;
            return fetch("https://api.themoviedb.org/3/tv/".concat(id, "/credits?api_key=276770bbde205f73041b92d3087003ed&language=en-US"));
          ...
          case 15:
            return _context9.abrupt("return", result.cast);
...
function animateScreen(elem) {
  ...
  var close = eval(elem).firstElementChild; // console.log(close);
...
function displayContent(arr) {
  ...
  arr.forEach( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(item) {
      var genres, title, date, type, searchResult;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return getGenre(item.genre_ids);
            ...
            case 2:
              ...
              searchResult.innerHTML = "\n    <img src=\"https://image.tmdb.org/t/p/w500".concat(item.backdrop_path, "\" alt=\"\" srcset=\"\">\n    <div class=\"movieCard\">\n      <h4>").concat(title, " (").concat(date.getFullYear(), ")</h4>\n      <p><b>Description:</b> ").concat(item.overview, "</p>\n      <p><b>Genres:</b> ").concat(genres, "<span>    <b>Type:</b> ").concat(type, "</span></p>\n      \n    </div>");
              setTimeout(function () {
...
function displayItem(_x7, _x8) {
  return _displayItem.apply(this, arguments);
} // CLICK ANIMATION


function _displayItem() {
  _displayItem = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(id, type) {
    var res, result, trailer, genres, title, date, cast, displayItem, poster, movieCard, cardTitle, cardDescription, cardCast, cardGenre, video;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 2:
            ...
            _context10.next = 6;
            return fetch("https://api.themoviedb.org/3/movie/".concat(id, "?api_key=276770bbde205f73041b92d3087003ed&language=en-US\n    "));
          ...
          case 15:
            _context10.next = 17;
            return fetch("https://api.themoviedb.org/3/tv/".concat(id, "?api_key=276770bbde205f73041b92d3087003ed&language=en-US\n    "));
          ...
          case 29:
            ...
            poster = new Image();
            poster.src = "https://image.tmdb.org/t/p/w500".concat(result.poster_path);
            movieCard = document.createElement("div");
            movieCard.className = "movieCard";
            cardTitle = document.createElement("h4");
            cardTitle.className = "cardTitle";
            cardTitle.innerHTML = "".concat(title, " (").concat(date.getFullYear(), ")<span>Rating: ").concat(result.vote_average, "/10</span>");
            cardDescription = document.createElement("p");
            cardDescription.innerHTML = "<b>Description:</b> ".concat(result.overview);
            cardCast = document.createElement("div");
            ...
            cast.forEach(function (item) {
              ...
              actor.innerHTML = "\n      <img src=\"https://image.tmdb.org/t/p/w500/".concat(item.profile_path, "\" alt=\"actor image\" width=\"50px\">\n      <p>").concat(item.name, " as ").concat(item.character, "</p>");
              cardCast.appendChild(actor);
            });
            cardGenre = document.createElement("div");
            cardGenre.className = "genres";
            genres.forEach(function (item) {
              var gen = document.createElement("span");
              gen.textContent = "".concat(item);
              cardGenre.appendChild(gen);
            });
            video = document.createElement("div");
            video.className = "video";
            video.innerHTML = "<iframe src=\"https://www.youtube.com/embed/".concat(trailer[0].key, "\" allowfullscreen></iframe>");
            setTimeout(function () {
...
function handleEvent(e) {
  ...
  var fillAnimation = (0, _animeEs.default)({
    targets: pageFill,
    r: targetR,
  ...
  var rippleAnimation = (0, _animeEs.default)({
    targets: ripple,
    r: rippleSize,
    opacity: 0,
    easing: "easeOutExpo",
  ...
  for (var i = 0; i < 32; i++) {
    var particle = new Circle({
      ...
      y: e.pageY,
      fill: currentColor,
      r: _animeEs.default.random(24, 48)
    });
    particles.push(particle);
  }

  var particlesAnimation = (0, _animeEs.default)({
    targets: particles,
    x: function x(particle) {
      return particle.x + _animeEs.default.random(rippleSize, -rippleSize);
    },
    y: function y(particle) {
      return particle.y + _animeEs.default.random(rippleSize * 1.15, -rippleSize * 1.15);
    },
    r: 0,
    easing: "easeOutExpo",
    duration: _animeEs.default.random(1000, 1300),
    complete: removeAnimation
  });
...
var animate = (0, _animeEs.default)({
  duration: Infinity,
...
function startFauxClicking() {
  setTimeout(function () {
    fauxClick(_animeEs.default.random(cW * .2, cW * .8), _animeEs.default.random(cH * .2, cH * .8));
    startFauxClicking();
  }, _animeEs.default.random(200, 900));
}
...
},{"bootstrap":"node_modules/bootstrap/dist/js/bootstrap.esm.js","bootstrap/dist/css/bootstrap.css":"node_modules/bootstrap/dist/css/bootstrap.css","@fortawesome/fontawesome-free/css/all.css":"node_modules/@fortawesome/fontawesome-free/css/all.css","animejs/lib/anime.es.js":"node_modules/animejs/lib/anime.es.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./style.scss":"style.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
